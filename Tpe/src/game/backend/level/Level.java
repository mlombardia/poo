...
public abstract class Level extends Grid {
    ...
    protected GameState newState() {
        return new Level.LevelState(REQUIRED_SCORE, MAX_MOVES);
    }
    ...
    private class LevelState extends GameState {
        ...
        public boolean playerWon() {
            return getScore() >= requiredScore; //estaba como > pero es >=, una vez que llega ya esta
        }
    }
}
